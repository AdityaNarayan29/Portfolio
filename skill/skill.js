...
const skills = ['Java / JavaScript / C++', 'MongoDB / MySQL', 'NodeJS / ExpressJS', 'AWS / GCP', 'ReactJS / CSS / Bootstrap / AntD', 'Core CS / OS / CN', 'OOPs', 'Problem Solving', 'Data Structures', 'Algorithms'];
